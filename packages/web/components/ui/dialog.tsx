  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        ...
        // Ensure proper backdrop in light mode with fallback
        "backdrop-blur-sm",
        "supports-[backdrop-filter]:bg-black/30 supports-[backdrop-filter]:dark:bg-black/50",
        className
      )}
      {...props}
    />
    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          // Enhanced styling for better light mode visibility
          "shadow-2xl backdrop-blur-sm",
          // Ensure content stands out in light mode
          "light:bg-white light:border-gray-200 light:shadow-xl",
          className
        )}
        {...props}
      >
