...
class ModelLoader:
    ...
    def _get_config(self, filename: str) -> json:
        ...
        # models.json is in the parent directory of the 'src' directory where this script lives
    ...
    def get_model_path_subdirectory(self, model_name: str) -> ort.InferenceSession:
        ...
        # The 'models' directory is a sibling to the 'src' directory
        model_subdirectory_path = Path(__file__).parent.parent/"models"/model_subdirectory 
